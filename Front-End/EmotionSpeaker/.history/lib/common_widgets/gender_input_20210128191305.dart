...
import 'package:Enaba/constants/colors.dart';
import 'package:get/get.dart';
import 'package:Enaba/common_widgets/icon_text_row.dart';
...
class _GenderInputState extends State<GenderInput> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        IconTextRow(icon: Icons.favorite, title: 'Gender'.tr),
        Row(
          children: [
            SizedBox(
              ...
              child: Row(
                children: [
                  Radio(
                    ...
                    activeColor: EnabaColors.yellowBrown,
                  ),
                  Text(
                    'Male'.tr,
                    style: TextStyle(

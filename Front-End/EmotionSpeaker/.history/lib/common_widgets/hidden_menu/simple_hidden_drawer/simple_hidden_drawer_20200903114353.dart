...
import 'package:kid_entertain/src/ui/widgets/hidden_menu/controllers/animated_drawer_controller.dart';
import 'package:kid_entertain/src/ui/widgets/hidden_menu/controllers/simple_hidden_drawer_controller.dart';
import 'package:kid_entertain/src/ui/widgets/hidden_menu/simple_hidden_drawer/animated_drawer_content.dart';
import 'package:kid_entertain/src/ui/widgets/hidden_menu/simple_hidden_drawer/provider/simple_hidden_drawer_provider.dart';
import 'package:kid_entertain/src/ui/widgets/hidden_menu/util/change_notifier_consumer.dart';
...
class SimpleHiddenDrawer extends StatefulWidget {
  ...
  /// enable animation Rotate
  final bool enableRotateAnimation;
  ...
  const SimpleHiddenDrawer(
      ...
      this.enableRotateAnimation = false,
...
class _SimpleHiddenDrawerState extends State<SimpleHiddenDrawer>
  ...
  Widget _createContentDisplay() {
    return AnimatedDrawerContent(
      ...
      enableRotateAnimation: widget.enableRotateAnimation,
